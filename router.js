...
router.get('/', (req, res) => {
    res.render('index', {title: 'ETU Library'});
});

router.get('/library', (req, res) => {
    res.render('library', {title: 'ETU Library', books: book_json});
});
...
router.get('/book/:id', (req, res) => {
    ...
    for (let value of book_json) {
        if (value.id == id) {
            res.render('book', {
                page_title: 'ETU Library', ID: `${value.id}`, title: `${value.title}`,
                author: `${value.author}`, date: `${value.date}`, in_stock: `${value.in_stock}`, cover: `${value.cover}`,
